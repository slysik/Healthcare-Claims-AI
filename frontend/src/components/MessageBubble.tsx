  ...
  if (message.role === 'user') {
    return (
      <div className="flex justify-end">
        <div className="max-w-[80%] bg-gradient-to-br from-brand-500 to-brand-600 text-white rounded-2xl rounded-br-md px-4 py-2.5 shadow-md">
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[90%] space-y-3">
        ...
        {/* Answer */}
        <div className="bg-white rounded-xl ring-1 ring-brand-100 shadow-sm hover:shadow-md transition-shadow duration-200 p-4">
